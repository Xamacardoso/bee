...
def abaixo_metade(matriz, funcao, operacao):
    ...
    for x in range(len(matriz)//2-1): # vai da segunda linha ate o final
        for y in range(x+1, len(matriz)-1 - x): # descobre qual coluna devo começar a pegar os verdinhos
